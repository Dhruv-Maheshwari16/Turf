...
import ParticlesBackground from "./ParticlesBackground"; // Import your ParticlesBackground component
...
const FeatureCard = memo(({ feature, idx }) => {
  ...
  return (
    <motion.div 
      ...
      className="group relative flex flex-col h-full min-h-[400px] lg:min-h-[450px] rounded-[2rem] border border-white/10 bg-black/5 backdrop-blur-sm overflow-hidden transform-gpu will-change-transform shrink-0 w-[85vw] lg:w-full snap-center transition-all duration-500"
    >
      <div
...
const Features = () => {
  ...
  return (
    <section ref={containerRef} id="features" className="relative py-20 min-h-[1000px] bg-[#050507] overflow-hidden">
      <ParticlesBackground />
